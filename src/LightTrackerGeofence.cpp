...
_meshtastic_Config_LoRaConfig_RegionCode Lorawan_Geofence_position(float latitude, float longitude)
{
	...
	if(longitude > -33.0 && longitude < 87.0)
	{
		...
		if (pointInPolygonF(8, BelarusUkraineF, latitude, longitude) == 1) {
            return(meshtastic_Config_LoRaConfig_RegionCode_UA_868);
		} 
		//Israel
